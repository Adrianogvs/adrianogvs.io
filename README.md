...
| Estilo | CSS3 com custom properties, temas dark/light, responsivo |
...
| Sobre Mim | Bio profissional com empresas, métricas (SLA 99,5%), stack e disponibilidade |
| Habilidades Técnicas | 8 cards: Data Engineering, Cloud, Programação, Big Data, DW, Orquestração, DataOps, BI |
| Experiências | Timeline: Petrobras, Apex Brasil, Renner, Globalsys, Águia Branca, TACOM |
| Onde Já Entreguei | Grid de 6 empresas com hover |
| Projetos | 6 cards com tags e links para repositórios GitHub |
| Certificações | 12 cards com links diretos para credenciais verificadas |
...
**Fundamentos**
- SC-900 · DP-900 · AI-900 · PL-900 · dbt Fundamentals · Airflow Fundamentals
