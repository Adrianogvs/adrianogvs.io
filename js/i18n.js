...
const translations = {
  pt: {
    ...
    // ── Experiências ──────────────────────────────────────
    'exp.now':              'Atualmente',
    'exp.more': 'Ver trajetória completa',
    'exp.less': 'Ver menos',
    'proj.petro.result': '1 milhão de registros · 35 concessionárias · 2007–2025',
    'metric.sla': 'SLA nos pipelines críticos',
    'metric.sla.v': '99,5%',
    'metric.rel_estrat': 'tempo de relatórios estratégicos',
    'metric.tempo_lib': 'do tempo liberado de tarefas manuais',
    'metric.rel_estoque': 'tempo de relatórios de estoque',
    ...
    'exp.horizonte.h3': 'Software Developer',
    'exp.horizonte.desc': 'Desenvolvimento do <strong>Sistema de Gestão de Viagens</strong> para a Horizonte Turismo, empresa de fretamento rodoviário em Belo Horizonte: cadastro de viagens, veículos e motoristas, controle de quilometragem e combustível (Diesel S10/S500), gestão de custos (pedágios, diárias e despesas extras) e dashboards analíticos. Stack: <strong>Python</strong>, <strong>Streamlit</strong>, <strong>SQLite</strong>, <strong>pandas</strong> e <strong>Altair</strong>.',
    'exp.floramar.h3': 'Electronic Ticketing Coordinator & Business Analyst',
    'exp.floramar.desc': 'Coordenação do time de <strong>bilhetagem eletrônica</strong> com tecnologia <strong>TACOM</strong> na Auto Omnibus Floramar, operadora de transporte coletivo municipal de Belo Horizonte, e atuação como analista de negócios no ERP <strong>Globus</strong> (Praxio, antiga BgmRodotec), integrando a operação de bilhetagem à gestão da empresa.',
  ...
  en: {
    ...
    'about.p2': 'Currently placed at <strong>SEFAZ-ES</strong> via G4F, working as Senior Data Engineer focused on architecture, governance and data quality on <strong>Azure Databricks</strong> and <strong>Microsoft Fabric</strong>.',
    ...
    'exp.now':              'Present',
    'exp.more': 'See full career history',
    'exp.less': 'Show less',
    'proj.petro.result': '1 million records · 35 concessionaires · 2007–2025',
    'metric.sla': 'SLA on critical pipelines',
    'metric.sla.v': '99.5%',
    'metric.rel_estrat': 'strategic reporting time',
    'metric.tempo_lib': 'of time freed from manual work',
    'metric.rel_estoque': 'inventory reporting time',
    ...
    'exp.santa.h3':         'Senior Business Analyst',
    'exp.horizonte.h3': 'Software Developer',
    'exp.horizonte.desc': 'Developed the <strong>Trip Management System</strong> for Horizonte Turismo, a charter bus company in Belo Horizonte: trip, vehicle and driver registration, mileage and fuel tracking (Diesel S10/S500), cost management (tolls, driver per diems and extra expenses) and analytical dashboards. Stack: <strong>Python</strong>, <strong>Streamlit</strong>, <strong>SQLite</strong>, <strong>pandas</strong> and <strong>Altair</strong>.',
    'exp.floramar.h3': 'Electronic Ticketing Coordinator & Business Analyst',
    'exp.floramar.desc': 'Coordinated the <strong>electronic ticketing</strong> team using <strong>TACOM</strong> technology at Auto Omnibus Floramar, a municipal public bus operator in Belo Horizonte, and worked as business analyst for the <strong>Globus</strong> ERP (Praxio, formerly BgmRodotec), integrating ticketing operations with company management.',
  ...
  es: {
    ...
    'exp.less': 'Ver menos',
    'proj.petro.result': '1 millón de registros · 35 concesionarias · 2007–2025',
    'metric.sla': 'SLA en pipelines críticos',
    'metric.sla.v': '99,5%',
    'metric.rel_estrat': 'tiempo de informes estratégicos',
    'metric.tempo_lib': 'del tiempo liberado de tareas manuales',
    'metric.rel_estoque': 'tiempo de informes de inventario',
    ...
    'exp.santa.h3':         'Senior Business Analyst',
    'exp.horizonte.h3': 'Software Developer',
    'exp.horizonte.desc': 'Desarrollo del <strong>Sistema de Gestión de Viajes</strong> para Horizonte Turismo, empresa de transporte chárter en Belo Horizonte: registro de viajes, vehículos y conductores, control de kilometraje y combustible (Diésel S10/S500), gestión de costos (peajes, viáticos y gastos extra) y dashboards analíticos. Stack: <strong>Python</strong>, <strong>Streamlit</strong>, <strong>SQLite</strong>, <strong>pandas</strong> y <strong>Altair</strong>.',
    'exp.floramar.h3': 'Electronic Ticketing Coordinator & Business Analyst',
    'exp.floramar.desc': 'Coordinación del equipo de <strong>ticketing electrónico</strong> con tecnología <strong>TACOM</strong> en Auto Omnibus Floramar, operadora de transporte público municipal de Belo Horizonte, y actuación como analista de negocios en el ERP <strong>Globus</strong> (Praxio, antes BgmRodotec), integrando la operación de ticketing con la gestión de la empresa.',
